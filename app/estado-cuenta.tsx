...
const styles = StyleSheet.create({
  ...
  subtitle: { fontSize: 14, fontFamily: 'Inter_400Regular', color: Colors.textSecondary, marginBottom: 20, lineHeight: 20 },

  card: { backgroundColor: Colors.surface, borderRadius: 16, padding: 16, marginBottom: 14, borderWidth: 1, borderColor: Colors.border },
  cardTitle: { fontSize: 16, fontFamily: 'Inter_700Bold', color: Colors.textPrimary, marginBottom: 12 },
  cardHint: { fontSize: 13, fontFamily: 'Inter_400Regular', color: Colors.textSecondary, marginBottom: 12 },

  cta: { backgroundColor: Colors.primary, borderRadius: 14, padding: 16, alignItems: 'center' },
  ctaText: { fontSize: 15, fontFamily: 'Inter_700Bold', color: Colors.background },
  ...
  error: { fontSize: 12, fontFamily: 'Inter_400Regular', color: Colors.danger, textAlign: 'center', marginTop: 10 },

  totalCard: { backgroundColor: Colors.primary + '15', borderRadius: 16, padding: 18, marginBottom: 14, alignItems: 'center' },
  totalLabel: { fontSize: 12, fontFamily: 'Inter_600SemiBold', color: Colors.textSecondary, marginBottom: 4 },
  totalValue: { fontSize: 32, fontFamily: 'SpaceGrotesk_700Bold', color: Colors.primary },
  ...
  listDesc: { fontSize: 13, fontFamily: 'Inter_600SemiBold', color: Colors.textPrimary },
  listSub: { fontSize: 11, fontFamily: 'Inter_400Regular', color: Colors.textMuted, marginTop: 2 },
  listAmount: { fontSize: 14, fontFamily: 'SpaceGrotesk_700Bold', color: Colors.textPrimary },
  ...
  evitableMotivo: { fontSize: 12, fontFamily: 'Inter_400Regular', color: Colors.textSecondary, lineHeight: 17 },

  recoRow: { flexDirection: 'row', gap: 8, marginBottom: 8 },
  recoBullet: { fontSize: 14, fontFamily: 'Inter_700Bold', color: Colors.primary },
  recoText: { flex: 1, fontSize: 13, fontFamily: 'Inter_400Regular', color: Colors.textSecondary, lineHeight: 19 },
  ...
  goldTitle: { fontSize: 14, fontFamily: 'Inter_700Bold', color: Colors.primary, marginBottom: 6 },
  goldAmount: { fontSize: 22, fontFamily: 'SpaceGrotesk_700Bold', color: Colors.textPrimary, marginBottom: 8 },
  goldText: { fontSize: 13, fontFamily: 'Inter_400Regular', color: Colors.textSecondary, lineHeight: 20 },
