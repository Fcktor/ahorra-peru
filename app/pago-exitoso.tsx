...
const styles = StyleSheet.create({
  ...
  checking: { fontSize: 18, fontFamily: 'Figtree_700Bold', color: Colors.textPrimary, marginTop: 20 },
  title: { fontSize: 28, fontFamily: 'Archivo_800ExtraBold', color: Colors.primary, textAlign: 'center', marginBottom: 12 },
  sub: { fontSize: 13, fontFamily: 'Figtree_400Regular', color: Colors.textMuted, marginTop: 8 },
  body: { fontSize: 15, fontFamily: 'Figtree_400Regular', color: Colors.textSecondary, textAlign: 'center', lineHeight: 22, marginBottom: 32 },
  btn: {
