...
const styles = StyleSheet.create({
  ...
  btnPrimaryText: { fontSize: 16, fontFamily: 'Figtree_700Bold', color: Colors.background },
  btnSecondary: {
    borderRadius: 16,
    paddingVertical: 14,
    paddingHorizontal: 40,
  ...
  btnSecondaryText: { fontSize: 15, fontFamily: 'Figtree_600SemiBold', color: Colors.textSecondary },
});
